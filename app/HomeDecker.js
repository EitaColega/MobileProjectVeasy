...
import { ImageBackground, View, TouchableOpacity, ActivityIndicator, ScrollView, Text } from 'react-native';
				...
				<ImageBackground source={homedecker} style={styleshome.homeimage}>
					...
					<ScrollView contentContainerStyle={{ paddingVertical: 20, alignItems: 'center' }}>
						...
						{loadingLeaders ? (
							...
							<DeckCarousel title="Top 5 Leaders" decks={leaderDecks} itemWidth={300} />
						)}
					</ScrollView>
